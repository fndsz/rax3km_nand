...
git clone https://github.com/lllrrr/luci-app-banlogon.git package/lean/luci-app-banlogon #加入banlogon
git clone https://github.com/sirpdboy/luci-app-autotimeset package/lean/luci-app-autotimeset #加入autotimeset
cd ..
#cd ..
